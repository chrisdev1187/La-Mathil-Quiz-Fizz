...
function HomePage() {
  ...
  const [newSessionBingoMode, setNewSessionBingoMode] = React.useState("standard");
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex gap-2">
                          <button
                            type="button"
                            onClick={() => setNewSessionMode("bingo")}
                            disabled={isCreating}
                            className={`flex-1 py-2 px-4 rounded-lg font-bold transition-all duration-300 ${
                              newSessionMode === "bingo"
                                ? "bg-[#FFD700] text-black border-2 border-[#FFD700]"
                                : "bg-black/50 text-[#FFD700] border-2 border-[#FFD700]/50 hover:border-[#FFD700]"
                            }`}
                            style={{
                              boxShadow: newSessionMode === "bingo" ? "0 0 10px #FFD700" : "none",
                            }}
                          >
                            🎲 BINGO
                          </button>
                          <button
                            type="button"
                            onClick={() => setNewSessionMode("trivia")}
                            disabled={isCreating}
                            className={`flex-1 py-2 px-4 rounded-lg font-bold transition-all duration-300 ${
                              newSessionMode === "trivia"
                                ? "bg-[#FFD700] text-black border-2 border-[#FFD700]"
                                : "bg-black/50 text-[#FFD700] border-2 border-[#FFD700]/50 hover:border-[#FFD700]"
                            }`}
                            style={{
                              boxShadow: newSessionMode === "trivia" ? "0 0 10px #FFD700" : "none",
                            }}
                          >
                            🧠 TRIVIA
                          </button>
                      ...
                      {/* Bingo Mode Selection (for Bingo mode only) */}
                      {newSessionMode === "bingo" && (
                        <div className="space-y-2">
                          ...
                          <div className="flex gap-2">
                            <button
                              type="button"
                              onClick={() => setNewSessionBingoMode("standard")}
                              disabled={isCreating}
                              className={`flex-1 py-2 px-4 rounded-lg font-bold transition-all duration-300 ${
                                newSessionBingoMode === "standard"
                                  ? "bg-[#00FF00] text-black border-2 border-[#00FF00]"
                                  : "bg-black/50 text-[#00FF00] border-2 border-[#00FF00]/50 hover:border-[#00FF00]"
                              }`}
                              style={{
                                boxShadow: newSessionBingoMode === "standard" ? "0 0 10px #00FF00" : "none",
                              }}
                            >
                              🏆 STANDARD
                            </button>
                            <button
                              type="button"
                              onClick={() => setNewSessionBingoMode("manual")}
                              disabled={isCreating}
                              className={`flex-1 py-2 px-4 rounded-lg font-bold transition-all duration-300 ${
                                newSessionBingoMode === "manual"
                                  ? "bg-[#00FF00] text-black border-2 border-[#00FF00]"
                                  : "bg-black/50 text-[#00FF00] border-2 border-[#00FF00]/50 hover:border-[#00FF00]"
                              }`}
                              style={{
                                boxShadow: newSessionBingoMode === "manual" ? "0 0 10px #00FF00" : "none",
                              }}
                            >
                              🎮 MANUAL
                            </button>
                          ...
                          <div className="text-white/60 text-xs text-center">
                            {newSessionBingoMode === "standard" 
                              ? "First winner gets 2nd prize, full card gets 1st prize" 
                              : "Host decides when to announce winners"}
                          </div>
                        </div>
                      )}

                      {/* Rounds Configuration (for Bingo mode) */}
                      {newSessionMode === "bingo" && (
                        <div className="space-y-2">
                          <label className="block text-[#00FF00] font-bold text-sm">
                            🔢 Number of Rounds:
