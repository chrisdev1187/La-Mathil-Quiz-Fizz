        ...
        >
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
            ...
            <div className="flex items-center gap-8">
              ...
              {gameState.session.bingoMode && (
                <div className="text-center">
                  <div className="text-white/60 text-sm">BINGO MODE</div>
                  <div className="text-[#00BFFF] text-xl font-bold">
                    {gameState.session.bingoMode.toUpperCase()}
                  </div>
                </div>
              )}
